...
def main():
    ...
    default_dir = Path.home() / ".openclaw" / "workspace" / "mx_data" / "output"
    parser.add_argument('--output-dir', dest='output_dir', help=f'输出目录，默认 {default_dir}')
    ...
    default_output = Path(os.environ.get("MX_OUTPUT_DIR", Path.home() / ".openclaw" / "workspace" / "mx_data" / "output"))
