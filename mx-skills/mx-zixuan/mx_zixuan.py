...
支持查询、添加、删除东方财富自选股
统一输出到 ~/.openclaw/workspace/mx_data/output/
"""
...
def main():
    ...
    parser.add_argument("--output-dir", dest="output_dir", help=f"输出目录，默认 ~/.openclaw/workspace/mx_data/output")

    args = parser.parse_args()

    # Default output directory
    default_output = Path(os.path.expanduser('~')) / '.openclaw' / 'workspace' / 'mx_data' / 'output'
