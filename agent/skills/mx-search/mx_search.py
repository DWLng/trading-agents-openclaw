...
# 默认输出目录: /Users/mac/Library/Application Support/openclaw/mx_data/output/
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print(f"默认输出目录: /Users/mac/Library/Application Support/openclaw/mx_data/output/")
    ...
    if len(sys.argv) >= 3:
        ...
        # 默认输出到固定目录
        output_dir = Path("/Users/mac/Library/Application Support/openclaw/mx_data/output")
