...
def main():
    ...
    parser.add_argument('--output-dir', dest='output_dir', help='输出目录，默认 /Users/mac/Library/Application Support/openclaw/mx_data/output/')
    ...
    # Default output directory is fixed to /Users/mac/Library/Application Support/openclaw/mx_data/output/
    default_output = Path("/Users/mac/Library/Application Support/openclaw/mx_data/output")
